...
import DrBruno from "@/assets/adv-Bruno.jpeg";
      ...
      <div className="lg:hidden flex flex-col min-h-[100dvh]">
        <div className="relative h-[45vh] min-h-[340px] max-h-[460px] flex-shrink-0 overflow-hidden">
          <ParallaxPhoto
            src={DrBruno}
            alt="Dr. Bruno Cesar"
            position="object-top sm:object-[center_15%]"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-background via-transparent to-background/20" />

          <div
            className="absolute top-6 left-6 z-10 animate-fade-in opacity-0 [animation-fill-mode:both]"
          ...
          <div
            className="absolute bottom-6 left-6 z-20 animate-fade-up opacity-0 [animation-fill-mode:both]"
            style={{ animationDelay: "1.5s" }}
          >
            <div className="backdrop-blur-md bg-white/[0.02] border border-cream/10 px-5 py-3 rounded-2xl w-fit">
              <div className="flex flex-col">
                <p className="text-[12px] font-display italic text-cream/80 tracking-wider">
                  Dr. Bruno Cesar"
                </p>
                <div className="flex items-center gap-3 mt-1.5">
                  <p className="text-[8px] sm:text-[9px] text-foreground/50 uppercase tracking-widest">
                    OAB/CE 00.000
                  </p>
        ...
        <div className="relative flex-1 bg-background px-6 py-8 sm:py-12 flex flex-col justify-center text-center">
          <div className="relative z-10">
            <h1 className="font-display leading-[1.0] text-[2.2rem] sm:text-[2.8rem] mb-8 sm:mb-10">
              <span className="block text-foreground/90 font-light italic text-[1.8rem] sm:text-[2.4rem] mb-1">
                Resolva seu
              </span>
              <span className="block text-foreground uppercase tracking-tight font-bold mt-1 text-[#c2a36b]">
                {" "}
                problema
              </span>
              <span className="block text-cream italic font-light text-[1.8rem] sm:text-[2.4rem]">
                Jurídico antes que ele piore.
              </span>
            </h1>

            <p
              className="text-[14px] sm:text-[16px] tracking-wide text-foreground/80 leading-[1.6] sm:leading-[1.7] mb-10 sm:mb-14 max-w-[280px] sm:max-w-[320px] mx-auto animate-fade-up opacity-0 [animation-fill-mode:both]"
              style={{ animationDelay: "2s" }}
            >
              Atendimento direto, rápido e sem burocracia para resolver sua
              situação.
            </p>
      ...
      <div className="hidden lg:flex lg:flex-col lg:justify-center lg:h-screen">
        <div className="absolute inset-0 bg-background overflow-hidden">
          <div className="absolute top-0 right-0 w-[55%] h-full">
            ...
            >
              <ParallaxPhoto src={DrBruno} alt="Dr. Bruno Cesar" />
              <div className="absolute inset-0 bg-gradient-to-r from-background via-background/40 to-transparent" />
            </div>

            <div
              className="absolute bottom-16 left-0 z-30 animate-fade-up opacity-0 [animation-fill-mode:both]"
              style={{ animationDelay: "2.2s" }}
            >
              <div className="backdrop-blur-md bg-white/[0.02] border border-cream/10 p-6 rounded-3xl max-w-[280px]">
                <div className="flex items-center gap-4 mb-5">
                  <div className="w-24 h-24 rounded-full bg-cream/5 border border-cream/10 flex items-center justify-center overflow-hidden">
                    <img
                      src={logo}
                      alt="Logo"
                  ...
                  <div>
                    <h3 className="font-display text-lg text-cream/90 tracking-wide">
                      Dr. Bruno Cesar
                    </h3>
                    <p className="text-[9px] uppercase tracking-[0.3em] text-foreground/50">
                      Advogado
                    </p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-[10px] tracking-[0.2em] text-foreground/60 uppercase">
                    <span>OAB/CE</span>
                    <span className="text-cream/80">00.000</span>
                  </div>
        ...
        >
          <img src={logo} alt="Bruno Cesar Advocacia" className="w-40 h-auto" />
        </div>

        <div className="relative z-10 px-16 max-w-[50%]">
          <div className="relative mb-12 xl:mb-16">
            <h1
              className="font-display leading-[0.95] animate-fade-up opacity-0 [animation-fill-mode:both]"
              style={{ animationDelay: "0.8s" }}
            >
              <span className="block text-4xl lg:text-5xl xl:text-6xl 2xl:text-editorial-lg text-foreground/80 font-light italic mb-2">
                Resolva seu
              </span>
              <span className="block text-[4.5rem] lg:text-[5.5rem] xl:text-[6.5rem] 2xl:text-[7.5rem] text-foreground uppercase tracking-tighter font-bold -ml-2 text-[#c2a36b]">
                Problema
              </span>
              <span className="block text-4xl lg:text-5xl xl:text-6xl 2xl:text-editorial-lg text-cream italic font-serif mt-2">
                jurídico antes que ele piore.
              </span>
            </h1>
          </div>
          ...
          >
            <p className="text-xl lg:text-2xl xl:text-3xl tracking-wide text-foreground/70 leading-[1.8] mb-12 xl:mb-16 font-light">
              Fale agora com o Dr. Bruno Cesar. Atendimento{" "}
              <span className="text-foreground font-normal">
                direto, rápido e sem burocracia
              </span>{" "}
            ...
            <div className="flex items-center gap-4 mb-8 xl:mb-12">
              <div className="flex items-center gap-4 xl:gap-5 px-6 xl:px-8 py-3 xl:py-4 rounded-full bg-white/[0.1] border border-cream/40 backdrop-blur-md shadow-2xl">
                ...
                <span className="text-[11px] xl:text-[13px] uppercase tracking-[0.3em] xl:tracking-[0.4em] text-cream font-black">
                  Online agora — atendimento imediato
                </span>
              </div>
            </div>
